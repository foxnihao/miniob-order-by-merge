...
public:
  ...
  IndexScanner *create_scanner(std::vector<const char*>left_keys, std::vector<int> left_lens, bool left_inclusive,
                               std::vector<const char*>right_keys, std::vector<int> right_lens, bool right_inclusive) override;
  RC sync() override;
...
public:
  ...
  RC open(std::vector<const char*>left_keys, std::vector<int> left_lens, bool left_inclusive,
